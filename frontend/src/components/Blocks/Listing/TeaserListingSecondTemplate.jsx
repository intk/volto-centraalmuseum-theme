...
import './less/TeaserListingSecondTemplate.less';
...
const TeaserListingSecondTemplate = (props) => {
  const { items } = props;
...
TeaserListingSecondTemplate.propTypes = {
  items: PropTypes.arrayOf(PropTypes.any).isRequired,
};

export default TeaserListingSecondTemplate;
