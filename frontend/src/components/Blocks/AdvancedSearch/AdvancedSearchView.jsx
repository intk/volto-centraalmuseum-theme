...
const AdvancedSearch = () => {
  ...
  const handleSubmit = () => {
    ...
    history.push(
      `/${locale}/search#query=%5B%7B"i"%3A"portal_type"%2C"o"%3A"paqo.selection.any"%2C"v"%3A%5B"artwork"%5D%7D%2C%7B"i"%3A"SearchableText"%2C"o"%3A"paqo.string.contains"%2C"v"%3A"${encodeURIComponent(
        searchQuery,
